...
/**
 * Default layout for resume sections
 * Two-column layout: [left column sections, right column sections]
 */
...
/**
 * Metadata schema - Resume presentation and formatting
 * Contains template, layout, CSS, page settings, theme colors, and typography
 * 
 * TODO: This metadata is primarily for PDF generation and presentation.
 * In the LangGraph agent architecture, this will be used by Node 4 (GeneratePDFNode)
 * to properly format and style the generated resume PDF.
 */
